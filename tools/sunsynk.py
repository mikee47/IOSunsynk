...
SUNSYNK_REGISTERS = [
    ...
    RegDef(60, 'ActiveEnergyToday', Unit.WATTH, SCALE_100, Attr.ReadOnly),
    RegDef(61, 'ReactiveEnergyToday', Unit.VARH, SCALE_100, Attr.ReadOnly),
    RegDef(62, 'GridWorkTimeToday', Unit.SECOND, SCALE_NONE, Attr.ReadOnly),
    RegDef(63, 'ActiveEnergyTotal', Unit.WATTH, SCALE_100, Attr.ReadOnly),
    RegDef(64, 'ActiveEnergyTotalHigh', Unit.WATTH, SCALE_100, [Attr.ReadOnly, Attr.HighWord]),
    ...
    RegDef(186, 'PvPower1', Unit.WATT, SCALE_NONE, Attr.ReadOnly),
    RegDef(187, 'PvPower2', Unit.WATT, SCALE_NONE, Attr.ReadOnly),
    RegDef(188, 'PvPower3', Unit.WATT, SCALE_NONE, Attr.ReadOnly),
    RegDef(189, 'PvPower4', Unit.WATT, SCALE_NONE, Attr.ReadOnly),
