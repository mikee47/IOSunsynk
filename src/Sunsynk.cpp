...
DEFINE_FSTR_ARRAY(regInfo, RegInfo,
	...
	{&RegName::RatedPowerLow, 16, Unit::WATT, 1, 0x01},
	{&RegName::RatedPowerHigh, 17, Unit::WATT, 1, 0x09},
	...
	{&RegName::PvEnergyYear, 68, Unit::WATTH, 2, 0x01},
	{&RegName::PvEnergyYearHigh, 69, Unit::WATTH, 2, 0x09},
	{&RegName::BatChargeToday, 70, Unit::WATTH, 2, 0x01},
	{&RegName::BatDischargeToday, 71, Unit::WATTH, 2, 0x01},
	{&RegName::BatChargeTotal, 72, Unit::WATTH, 2, 0x01},
	{&RegName::BatChargeTotalHigh, 73, Unit::WATTH, 2, 0x09},
	{&RegName::BatDischargeTotal, 74, Unit::WATTH, 2, 0x01},
	{&RegName::BatDischargeTotalHigh, 75, Unit::WATTH, 2, 0x09},
	{&RegName::GridImportToday, 76, Unit::WATTH, 2, 0x01},
	{&RegName::GridExportToday, 77, Unit::WATTH, 2, 0x01},
	{&RegName::GridImportTotal, 78, Unit::WATTH, 2, 0x01},
	{&RegName::GridFrequency, 79, Unit::HERTZ, -2, 0x01},
	{&RegName::GridImportTotalHigh, 80, Unit::WATTH, 2, 0x09},
	{&RegName::GridExportTotal, 81, Unit::WATTH, 2, 0x01},
	{&RegName::GridExportTotalHigh, 82, Unit::WATTH, 2, 0x09},
	{&RegName::GenDailyOperatingTime, 83, Unit::SECOND, -1, 0x01},
	{&RegName::LoadEnergyToday, 84, Unit::WATTH, 2, 0x01},
	{&RegName::LoadEnergyTotal, 85, Unit::WATTH, 2, 0x01},
	{&RegName::LoadEnergyTotalHigh, 86, Unit::WATTH, 2, 0x09},
	{&RegName::LoadEnergyYear, 87, Unit::WATTH, 2, 0x01},
	{&RegName::LoadEnergyYearHigh, 88, Unit::WATTH, 2, 0x09},
	...
	{&RegName::PvEnergyTotal, 96, Unit::WATTH, 2, 0x01},
	{&RegName::PvEnergyTotalHigh, 97, Unit::WATTH, 2, 0x09},
